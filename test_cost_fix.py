...
print("\n" + "="*70)
print("Testing 14d/7d configuration...")
print("="*70)
...
result = solver.solve(
    ...
    verbose=False  # Turn off for cleaner output
)
...
print("\n" + "="*70)
print("Expected cost: ~$6.9M (previous baseline)")
print("If cost is significantly different, there may be a bug in the fix")
print("="*70)
