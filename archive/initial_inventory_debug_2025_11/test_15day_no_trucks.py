#!/usr/bin/env python3
"""Test: 15 days with truck_pallet_tracking=False."""
...
# Convert to 3-tuple with state inference
initial_inv = {}
...
print("="*80)
print("TEST: 15 days, truck_pallet_tracking=FALSE")
print("="*80)
...
model = SlidingWindowModel(
    ...
    allow_shortages=True, use_pallet_tracking=False, use_truck_pallet_tracking=False  # DISABLED
)
...
if result.is_optimal():
    print("✓ OPTIMAL - Truck pallet tracking was the issue!")
else:
    print("✗ INFEASIBLE - Not truck-related")
