...
product_ids = ['HELGAS GFREE MIXED GRAIN 500G', 'HELGAS GFREE TRAD WHITE 470G']
products = create_test_products(product_ids)

# Initial inventory: 2 products at hub 6125
initial_inv = {
    ('6125', 'HELGAS GFREE MIXED GRAIN 500G', 'ambient'): 100.0,
    ('6125', 'HELGAS GFREE TRAD WHITE 470G', 'ambient'): 100.0,
}

print("="*80)
print("TEST: 2 products at hub 6125, 2-day horizon")
print("="*80)
...
if result.is_optimal():
    print("✓ OPTIMAL - 2 products works!")
else:
    print("✗ INFEASIBLE - 2 products fails!")
