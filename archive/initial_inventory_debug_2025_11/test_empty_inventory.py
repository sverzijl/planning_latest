#!/usr/bin/env python3
"""Test: Does model solve with EMPTY initial inventory?"""
...
# Create EMPTY inventory snapshot
...
print(f"Empty inventory: {len(empty_inventory.entries)} entries")
...
print("\n" + "="*80)
print("TEST: SlidingWindowModel with EMPTY initial inventory")
print("="*80)
...
if result.success:
    print("✓ OPTIMAL - Model works with empty inventory!")
    print("→ Bug is in how initial inventory is used")
else:
    print("✗ STILL INFEASIBLE - Model has fundamental issues")
